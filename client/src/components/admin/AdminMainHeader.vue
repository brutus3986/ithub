            ...
            <div id="navbar" class="collapse navbar-collapse">
                <div class="navbar-nav mr-auto">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/specinfo" class="nav-link">특이사항</router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/admin/chart" class="nav-link">일간보고서</router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/admin/chartterm" class="nav-link">월간보고서</router-link>
                        </li>
                        <li class="nav-item">
